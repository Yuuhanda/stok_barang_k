              ...
              <table id="file" class="table striped">
                <thead>
                  <tr>
                    ...
                    <td width="5%"><strong>Available Unit</strong></td>
                    <td width="5%%"><strong>In-Use</strong></td>
                    <td width="5%"><strong>In-repair</strong></td>
                    <td width="5%"><strong>Total Lost</strong></td>
                  ...
                  while ($barang = $query->fetch_object()) { 
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="item-detail.php?id=<?= $barang->id_barang; ?>" class="btn btn-sm btn-info">View_detail</a>
                      </td>
                    </td>
                  </tr>
                  <?php
