...
if(empty($serial_n)){
    ...
    if ($mysqli->query("INSERT INTO barang_unit (id_barang, status, id_employee, id_gudang, id_user, comment, serial_number, kondisi) VALUES ('$id_barang', '0', NULL, '$id_gudang', '$id_admin', 'New Unit', '$autogenerated_sn', '0')")) {
        header('Location: ../admin/item-detail.php?id=' . $id_barang);   
        exit();
    } else {
